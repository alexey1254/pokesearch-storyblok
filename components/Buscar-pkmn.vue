<template>
  <div class="d-flex justify-content-center mt-1 mb-3">
    <input
      @keyup.enter="click"
      style="width: 300px"
      class="me-2 form-control text-center"
      type="input"
  ...
  <div
    class="container-fluid mt-3 d-flex align-items-center justify-content-center vh-90"
  >
    <div class="row">
      <div class="col">
        ...
        <div
          v-else
          class="card mt-3 d-inline-flex justify-content-center shadow-lg p-3 mb-5 bg-white rounded"
          style="width: 18rem"
        >
        ...
        <div v-if="!pokemon" class="card mt-3 d-inline-flex justify-content-center shadow-lg p-3 mb-5 bg-white rounded justify-content-center">
...
async function search() {
  ...
  try {
    const { data } = await useFetch(
      `https://pokeapi.co/api/v2/pokemon/${usrInput.value.toLowerCase()}`
    );
